...
namespace linalg
{
    ...
    namespace detail
    {
        ...
        template<class T, int M, int... I> vec<T,sizeof...(I)> constexpr swizzle(const vec<T,M> & v, seq<I...> i) { (void)i; return {getter<I>{}(v)...}; }
        template<class T, int M, int N, int... I, int... J> mat<T,sizeof...(I),sizeof...(J)> constexpr swizzle(const mat<T,M,N> & m, seq<I...> i, seq<J...> j) { (void)j; return {swizzle(getter<J>{}(m),i)...}; }
    ...
    template<class T> constexpr mat<T,1,1> adjugate(const mat<T,1,1> & a) { (void)a; return {vec<T,1>{1}}; }
